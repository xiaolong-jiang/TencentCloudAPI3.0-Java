 ...
 * 人像驱动
 */
public class SubmitVideoFaceDrivenJob {

    //腾讯云账户密钥，获取参考：https://console.cloud.tencent.com/cam/capi
    private static String SecretId  = "AKIDB7pGsF****KQGshJI0RcVXL5Zqukq9m";
    private static String SecretKey = "BGzTlJcfRz****8i49wS1KWR6anl";
    ...
    public static void main(String [] args) {
        ...
        params.put("ProjectId","306546");
        params.put("ModelId","qc_306546_733840_13");
        params.put("Url","https://test-1258389692.cos.ap-shenzhen-fsi.myqcloud.com/woman1.jpg");
        params.put("TemplateFaceID","1300");


        Gson gson = new Gson();
        String param = gson.toJson(params);
        //发送请求 本地封装的https 请求
        String response = getAuthTC3("SubmitVideoFaceDrivenJob", param, Version);
        //打印请求数据
