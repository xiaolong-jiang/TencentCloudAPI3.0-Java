...
public class SubmitVideoMultiFaceFusionJob {

    //腾讯云账户密钥，获取参考：https://console.cloud.tencent.com/cam/capi
    private static String SecretId  = "AKIDB7pGsFcWG****hJI0RcVXL5Zqukq9m";
    private static String SecretKey = "BGzTlJcfRzFGX****8i49wS1KWR6anl";
    ...
    public static void main(String [] args) {
        ...
        //用户人脸图片
        List<MergeInfo> list = new ArrayList<MergeInfo>();
        MergeInfo a = new MergeInfo();
        a.setUrl("https://test-1258389692.cos.ap-shenzhen-fsi.myqcloud.com/woman2.png");
        MergeInfo b = new MergeInfo();
        b.setUrl("https://test-1258389692.cos.ap-shenzhen-fsi.myqcloud.com/man1.png");
        a.setTemplateFaceID("201");
        b.setTemplateFaceID("200");
        list.add(a);
        list.add(b);
        params.put("MergeInfos", list);

        //加水印Logo图片
        LogoParam logoParam1=new LogoParam();
        Map<String, Object> map = new HashMap<>();
        map.put("LogoUrl","https://test-1258389692.cos.ap-shenzhen-fsi.myqcloud.com/Frame%20104.png");
        LogoRect logoRect1=new LogoRect();
        logoRect1.setX(88L);
        logoRect1.setY(88L);
        logoRect1.setWidth(200L);
        logoRect1.setHeight(50L);
        map.put("LogoRect",logoRect1);
        params.put("LogoParam",map);
        params.put("ProjectId","308607");
        params.put("ModelId","qc_308607_787571_2");

        Gson gson = new Gson();
        String param = gson.toJson(params);
        //发送请求 本地封装的https 请求
        String response = getAuthTC3("SubmitVideoMultiFaceFusionJob", param, Version);
        //打印请求数据
