...
public class SubmitVideoFaceFusionJob {

    //腾讯云账户密钥，获取参考：https://console.cloud.tencent.com/cam/capi
    private static String SecretId  = "AKIDB7pGsFc****shJI0RcVXL5Zqukq9m";
    private static String SecretKey = "BGzTlJcfRzF****pCJ8i49wS1KWR6anl";
    ...
    public static void main(String [] args) {
        ...
        mergeInfo.setUrl("https://test-1258389692.cos.ap-shenzhen-fsi.myqcloud.com/woman1.jpg");
        mergeInfo.setTemplateFaceID("3600");
        list.add(mergeInfo);
        params.put("MergeInfos", list);
        //Logo图
        LogoParam logoParam1=new LogoParam();
        Map<String, Object> map = new HashMap<>();
        map.put("LogoUrl","https://test-1258389692.cos.ap-shenzhen-fsi.myqcloud.com/%E7%94%A8%E6%88%B7%E6%B0%B4%E5%8D%B0%E5%8E%9F%E5%9B%BE.png");
        LogoRect logoRect1=new LogoRect();
        logoRect1.setX(53L);
        logoRect1.setY(53L);
        logoRect1.setWidth(236L);
        logoRect1.setHeight(236L);
        map.put("LogoRect",logoRect1);
        params.put("LogoParam",map);
        params.put("ProjectId","306557");
        params.put("ModelId","qc_306557_338601_36");
        Gson gson = new Gson();
        String param = gson.toJson(params);
        //发送请求 本地封装的https 请求
        String response = getAuthTC3("SubmitVideoFaceFusionJob", param, Version);
        //打印请求数据
