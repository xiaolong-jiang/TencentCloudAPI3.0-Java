...
public class QueryVideoJob {

    //腾讯云账户密钥，获取参考：https://console.cloud.tencent.com/cam/capi
    private static String SecretId  = "AKIDB7p****T0KQGshJI0RcVXL5Zqukq9m";
    private static String SecretKey = "BGzTlJc****GXXGpCJ8i49wS1KWR6anl";
    ...
    public static void main(String [] args) {
        ...
        params.put("JobId","004A8C75EA1567C35568C4AC8A8121060BC");


        Gson gson = new Gson();
        String param = gson.toJson(params);
        //发送请求 本地封装的https 请求
        String response = getAuthTC3("QueryVideoJob", param, Version);
        //打印请求数据
